...
function coverPage() {
  return [
    ...
    new Paragraph({
      alignment: AlignmentType.CENTER,
      children: [new TextRun({ text: "Version 5.0  |  June 2026  |  CONFIDENTIAL", font: "Arial", size: 28, color: "718096" })],
...
function section1() {
  return [
    ...
    para(""),
    para("The system currently processes devices across 14 distinct operational stages, supports 11 user roles with granular RBAC enforcement, and integrates a CRM pipeline for both supplier sourcing and buyer opportunity management. As of June 2026 (Sprint 29) the platform adds an end-to-end work-order, spare-parts fulfilment and dispatch-approval layer on top of the core lifecycle: 12-digit WorkID engineer assignment, an IQC-driven parts request/handover/sourcing chain, and a grade-split Ready to Dispatch module with telecaller request approval. Four new workflow tables bring the schema to 61 tables. Compliance remediation against enterprise CLAUDE.md standards remains underway toward the 8.3/10 SaaS-launch target."),
    para(""),
    ...
    dataTable(
      ...
      [
        ...
        ["Database", "PostgreSQL 15, 61 tables, 11 Alembic migrations + create_all"],
        ...
        ["Total DB Tables", "61 tables across all modules (57 + 4 Sprint 29 workflow tables)"],
      ],
      [2800, 5960]
    ),
    pageBreak(),
...
function section6() {
  return [
    h1("6. Database Schema - All 61 Tables", "s6"),
    ...
    headers: {
      default: new Header({
        children: [new Paragraph({
          ...
          children: [
            new TextRun({ text: "OxyPC Inventory Management System  |  BRD v5.0  |  CONFIDENTIAL  |  June 2026", font: "Arial", size: 18, color: "4A5568" }),
          ],
        })],
      }),
    },
...
Packer.toBuffer(doc).then(buf => {
  const out = "C:/Users/Pankaj.sehgal/Claude/Oxypc/oxypc-inventory/docs/OxyPC_BRD_v5_Complete.docx";
